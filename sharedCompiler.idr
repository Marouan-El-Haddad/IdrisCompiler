...
evalOpenProg (MkOpenProgram op_funDecl op_return_type op_arg_type val_arg (ExpVar x)) = ?evalOpenProg_rhs_1
evalOpenProg (MkOpenProgram op_funDecl Tint op_arg_type val_arg (ExpVal x)) = ?evalOpenProg_rhs_2
evalOpenProg (MkOpenProgram op_funDecl Tint op_arg_type val_arg (ExpAddition x y)) = ?evalOpenProg_rhs_3
evalOpenProg (MkOpenProgram op_funDecl (op_funDecl .fd_return_type) op_arg_type val_arg (ExpFuncCall x)) = ?evalOpenProg_rhs_4
